...
#
# Generated by export_simulation on Thu Oct 17 15:15:49 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './Floaty_board_design.sh' script.

./Floaty_board_design.sh -reset_run
...
./Floaty_board_design.sh -noclean_files

For more information on the script, please type './Floaty_board_design.sh -help'.
